...
<p>If <a href="http://<?php echo $person->url;?>" title="<?php echo $person->name;?>'s 6d site"><?php echo $person->name;?></a> chooses to accept your request, a notification will be sent to your site and their 6d siteadded to your address book.</p>
