<div id="addressbook" class="addressbook">
	...
	<section id="groups" class="groups">
		...
		<?php foreach($groups as $key=>$group):?>
			<li rel="<?php echo $group->text;?>" class="<?php echo ($group->id == -1 ? 'selected' : '')?>">
				...
				<label for="group_<?php echo $key;?>"><span><?php echo $group->text;?></span></label>
	...
	<footer id="toolbar" class="footer">
...
<section id="instructions" class="instructions">
	<ul>
		...
		<li>Add a contact by clicking on "Create a Card" (as in roladex card), filling out their name in the new field and pressing the "enter" or "return" key.</li>
	</ul>
</section>
