...
class FeedResource extends AppResource{
	...
	public $limit;
	public static function get_todays_feed_count(){
	...
	public static function get_todays_posts($is_authed, $person_id, $page, $sort_by, $sort_by_direction, $direction, $tag, $q, $limit){
		$posts = null;
		$posts = Post::findTodaysFeed($page, $limit, $sort_by, $sort_by_direction, $is_authed, $person_id);
		return $posts;
